<?php
//La clase conexion trae tanto crear modificar y eliminar servicios como canales.
...
function Crear_Canal(){
    ...
    $token  = "232c491053bb1103232a62ecfb1584de";
    $twilio = new Client($sid, $token);
    $channel = $twilio->chat->v2->services("IS4450342d288b4f36bf624ae84d0537f8")->channels->create(array("friendlyName" => $Nombre));
...
function Modificar_Canal(){
    ...
    $token  = "232c491053bb1103232a62ecfb1584de";
    $twilio = new Client($sid, $token);
    $channel = $twilio->chat->v2->services("IS4450342d288b4f36bf624ae84d0537f8")->channels("CHXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX")->update(array("friendly_name" => "Canal X"));
    print($channel->friendlyName);
}
...
function Eliminar_Canal(){
    ...
    $token  = "232c491053bb1103232a62ecfb1584de";
    $twilio = new Client($sid, $token);
    $twilio->chat->v2->services("IS4450342d288b4f36bf624ae84d0537f8")->channels("CHe690aaebfd8a400ea9d902464c25c298")->delete();
}