<?php
//traemos los datos y los metodos 
...
//Este archivo es la vista con la cual el usuario una ves iniciado sesion y aver escogido el canal, se muestra esta vista con las opciones de poder observar 
//los integrantes de cada canal asi como permitir escribir mensajes en el.
?>
<!DOCTYPE html>
<html class="no-js" lang="en">
    ...
    <body id="top">
        ...
        <section id="contact" class="s-contact">
            ...
            <h3 class="h6">Chatea en linea: <?PHP echo $Usuario; ?></h3>
            ...
            <input action="<?php?>" type='submit' class='btn btn-primary'  value='Agregar'>
            </form>                
            </div>
            <textarea  readonly="readonly" rows="90" cols="100" style="margin: 0px 0px 9px; width: 816px; height: 169px;" ><?php  $clase ->EnviarMns(); $clase ->ListarMns(); ?></textarea>
            </fieldset>
